...
- Method naming must follow camelCase convention for test methods (e.g. findByIdShouldReturnUserWhenIdIsValid, findByIdShouldThrowNoSuchElementExceptionWhenUserIsNotPresent)
- Avoid reflection in tests.
- Avoid business logic in tests; focus on behavior verification.
- Write unit tests where necessary
- Write integration tests where necessary
- Cover all branches, conditions and exceptions
...
- Use YAML for migrations/changelogs
